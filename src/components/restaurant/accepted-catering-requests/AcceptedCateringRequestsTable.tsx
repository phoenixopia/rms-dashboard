...
export default function AcceptedCateringRequestsTable({ data }: any) {
      ...
      {data?.length === 0 ? (
        ...
        <div className="bg-card rounded-md border">
          <Table>
            ...
            <TableBody>
              {data?.map((catering: any, index: any) => {
                return (
                  <TableRow
                    key={catering.id}
                    className={`${index % 2 !== 0 ? "bg-muted" : ""} border-none`}
                  >
                    <TableCell>{catering?.catering_title}</TableCell>
                    <TableCell>{catering?.customer_name ?? "N/A"}</TableCell>
                    <TableCell>{catering?.estimated_price ?? "N/A"}</TableCell>
                    <TableCell>{catering?.prepayment_percentage ?? "N/A"}</TableCell>
                    <TableCell>{catering?.status ?? "N/A"}</TableCell>
