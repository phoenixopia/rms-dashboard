...
export default async function CateringPage({
  ...
  try {
    data = await getAllSubscriptions(page, limit);
  } catch (err: any) {
    console.error("Error fetching subscription data:", err);
    error = `Failed to load subscriptions. Please try again later.${err}`;
  }
  ...
  return (
    <div className="container mx-auto py-5">
      ...
      <div className="flex flex-row justify-between">
        ...
        <Link className="flex p-2 rounded-md bg-gray-200" href="/dashboard/restaurant/subscription/new"> Add receipt </Link>
